...
class Library():  # declare class
    Library_Name= "City Central Library"  # class Variable

    def __init__(self,book_name,author_name,available_copies):  # Constructor
        self.book_name=book_name
        self.author_name=author_name
        self.available_copies=available_copies

    def book_info(self):  # Object Method 1
    ...
    def borrow_book(self):    # Object Method 2
    ...
    def return_book(self):    # Object Method 3
        self.available_copies +=1
